//non-functional requirment instance generated from row 2
Instance: BDS.NFXNREQ.2
InstanceOf: SGRequirements
Usage: #definition
* title = "Provide a means to ensure confidentiality and privacy of personal health information"
