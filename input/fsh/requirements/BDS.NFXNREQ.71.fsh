//non-functional requirment instance generated from row 71
Instance: BDS.NFXNREQ.71
InstanceOf: SGRequirements
Usage: #definition
* title = "Provide ability to create, read, update and delete report templates to use for automated reporting"
